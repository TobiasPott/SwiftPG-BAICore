...
public extension ArtPalette {
    ...
    static let floralArtInv: ArtInventory = ArtInventory.inventory(floarlArtName, inventory: ArtInventory(name: floarlArtName, items: floralArtItems, isEditable: false))
