        ...
        ZStack {
            GroupBox(label: Text("Source Code and FOSS"), content: {
                ScrollView {
                    ...
                    Text("FOSS").font(.headline).padding(.bottom, 6).padding(.top)
                    ...
                    Text("Source Code").font(.headline).padding(.bottom, 6).padding(.top)
                    ...
                    Text("References and Resources").font(.headline).padding(.bottom, 6).padding(.top)
